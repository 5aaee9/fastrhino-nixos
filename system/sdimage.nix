# `nixos/modules/installer/sd-card/sd-image.nix` patched for R66s.
...
in
{
  ...
  options.sdImage = {
    ...
    firmwarePartitionID = mkOption {
      type = types.str;
      default = "a65254c6-2f3c-452b-bf1e-91ce07a0d8d4";
      description = ''
    ...
    mtools, libfaketime, util-linux, zstd }: stdenv.mkDerivation {
      ...
      buildCommand = ''
        ...
        sfdisk $img <<EOF
            ...
            start=''${gap}M, size=$firmwareSizeBlocks, type=83, bootable
        ...
        # Create a EXT4 /boot/firmware partition of suitable size into firmware_part.img
        ...
        faketime "1970-01-01 00:00:00" mkfs.ext4 -U ${config.sdImage.firmwarePartitionID} -L ${config.sdImage.firmwarePartitionName} -d ./firmware firmware_part.img

        fsck.ext4 -vn firmware_part.img
